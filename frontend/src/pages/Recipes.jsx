              ...
              <div className="grid grid-cols-2 gap-4 text-center">
                ...
                <div className="p-3 bg-surface-container-lowest rounded-lg border border-outline-variant/50">
                  ...
                  <p className="font-metric-lg text-sm font-bold">
                    {selectedRecipe.target_fg_low} - {selectedRecipe.target_fg_high}
                  </p>
                </div>
              </div>
            </div>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <input
                      type="number"
                      step="0.1"
                      value={editForm.total_volume_gal}
                      onChange={(e) =>
                        setEditForm({ ...editForm, total_volume_gal: e.target.value })
                      }
                      className="bg-surface-container-low border border-outline-variant rounded p-3"
                      required
                    />
                ...
                <div className="grid grid-cols-3 gap-4 border-t border-surface-container pt-4">
                  <div className="flex flex-col gap-1">
                    ...
                    <input
                      type="number"
                      step="0.001"
                      value={editForm.target_og}
                      onChange={(e) => setEditForm({ ...editForm, target_og: e.target.value })}
                      className="bg-surface-container-low border border-outline-variant rounded p-3"
                      required
                    />
                  </div>
                  <div className="flex flex-col gap-1">
                    ...
                    <input
                      type="number"
                      step="0.001"
                      value={editForm.target_fg_low}
                      onChange={(e) => setEditForm({ ...editForm, target_fg_low: e.target.value })}
                      className="bg-surface-container-low border border-outline-variant rounded p-3"
                      required
                    />
                  </div>
                  <div className="flex flex-col gap-1">
                    ...
                    <input
                      type="number"
                      step="0.001"
                      value={editForm.target_fg_high}
                      onChange={(e) => setEditForm({ ...editForm, target_fg_high: e.target.value })}
                      className="bg-surface-container-low border border-outline-variant rounded p-3"
                      required
                    />
                  </div>
                        ...
                        <div className="grid grid-cols-4 gap-2 flex-1">
                          ...
                          <label className="flex items-center gap-2 text-xs text-on-surface-variant">
                            <input
                              ...
                              onChange={(e) =>
                                handleIngredientChange(idx, 'scalable', e.target.checked)
                              }
                ...
                <div className="border-t border-surface-container pt-4 space-y-4">
                  <div className="flex flex-col gap-1">
                    ...
                    <textarea
                      rows="6"
                      value={editForm.method_markdown}
                      onChange={(e) =>
                        setEditForm({ ...editForm, method_markdown: e.target.value })
                      }
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <textarea
                      ...
                      onChange={(e) => setEditForm({ ...editForm, notes_markdown: e.target.value })}
                      className="bg-surface-container-low border border-outline-variant rounded p-3 font-body-md"
                    />
                  </div>
                </div>
        ...
        {recipes.map((recipe) => (
          <div
            ...
            onClick={() => {
              ...
              setDesiredVolume(recipe.total_volume_gal)
            }}
